...
matrix operator*(const matrix &a, const matrix &b)
{
    matrix c;
    c.init();
    c.arr[0][0] = a.arr[0][0] * b.arr[0][0] + a.arr[0][1] * b.arr[1][0];
    c.arr[0][1] = a.arr[0][0] * b.arr[0][1] + a.arr[0][1] * b.arr[1][1];
    c.arr[1][0] = a.arr[1][0] * b.arr[0][0] + a.arr[1][1] * b.arr[1][0];
    c.arr[1][1] = a.arr[1][0] * b.arr[0][1] + a.arr[1][1] * b.arr[1][1];
    return c;
}
signed main(void)
{
    cin >> a >> b >> n;
    mint denom = 1LL * a * a + 1LL * b * b;
    mint c = 1LL * b * b - 1LL * a * a;
    mint d = 2LL * a * b;
    c = c / denom;
    d = d / denom;
    n++;
    //cout << c << " " << d << " " << inv(1lint * a * a + 1lint * b * b) << endl;
    matrix coef;
    matrix res;
    res.init();
    coef.init();
